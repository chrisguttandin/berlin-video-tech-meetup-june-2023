    ...
    return {
        ...
        'lint-src': {
            cmd: `htmlhint --config config/htmlhint/document.json 'src/**/index.html' && \
                ...
                npx ng lint berlin-video-tech-meetup-june-2023 && \
                npx stylelint 'src/**/*.scss' --config config/stylelint/config.json`
        },
        'lint-test': {
            cmd: 'npx ng lint berlin-video-tech-meetup-june-2023 --configuration test'
        },
        'monitor': {
            cmd: 'npx ng serve'
        },
        'prerender': {
            cmd: `npx ng run berlin-video-tech-meetup-june-2023:server:production && \
                npx angular-prerender \
                    --browser-target berlin-video-tech-meetup-june-2023:build \
                    --preserve-index-html \
                    --server-target berlin-video-tech-meetup-june-2023:server`
        },
        'preview': {
        ...
        'verify': {
            cmd: `npx bundle-buddy build/berlin-video-tech-meetup-june-2023/*.js.map && \
