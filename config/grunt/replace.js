...
module.exports = (grunt) => {
    return {
        ...
        'manifest': {
            files: {
                './': ['build/berlin-video-tech-meetup-june-2023/browser/ngsw.json']
            },
            options: {
                patterns: [
                    {
                        ...
                        replacement: (_, filename, extension) =>
                            grunt.file.expand(
                                { cwd: 'build/berlin-video-tech-meetup-june-2023', ext: extension },
                                `assets/${filename}.*`
                            )[0]
                    },
                    {
                        ...
                        replacement: (_, filename) => {
                            return `"/berlin-video-tech-meetup-june-2023/browser/${filename}.html": "${computeHashOfFile(
                                `build/berlin-video-tech-meetup-june-2023/browser/${filename}.html`,
                                'sha1',
                                'hex'
                            )}"`;
                        }
