...
export default defineConfig([
    ...
    { files: ['**/*.html'], rules: { 'padding-line-between-statements': 'off' } },
    {
        files: ['**/*.ts'],
        rules: {
            '@angular-eslint/component-selector': ['error', { prefix: 'vtm', style: 'kebab-case', type: 'element' }],
            '@angular-eslint/directive-selector': ['error', { prefix: 'vtm', style: 'camelCase', type: 'attribute' }],
